...
export type { OperatorMessage, ResendState, TransactionDetails };
...
// --- StatusOverlay ---
export function StatusOverlay({ message = "Processing..." }: { message?: string }) {
  return (
...
export function TransactionDetailsBox({ details }: { details: TransactionDetails }) {
